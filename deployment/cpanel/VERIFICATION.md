...
- `npm test`: **51 tests passed, 0 failed**. Covers migrated public forms and HR actions, ownership/write-permission rejection, saved-data field mappings, duplicate registration/finalization, checked DB failures, mail transport/authorization/failure handling, complaints, attendance and existing Phase 1A checks. Includes nine deployment/health/bootstrap tests added with the GitHub Actions rewrite. Tests use isolated fixture data and mocked mail; they do not exercise live accounts.
